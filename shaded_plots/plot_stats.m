function l = plot_stats(varargin)
...
[X,Y,ax_,color_value,alpha_value,line_style,line_width] = parseinputs(varargin{:});
...
l = line('parent',ax_,'xdata',X,'ydata', MU,'color',color_value,'LineStyle',line_style, 'LineWidth', line_width);
% l = line(X,MU,'LineWidth',line_width,'Color',color_value);
hold off
...
function [X,Y,ax_,color_value,alpha_value,line_style,line_width] = parseinputs(varargin)
...
if nargin > minargs
    for i=(minargs+1):2:nargin
        ...
        PNAME = validatestring(PNAME,{'Alpha','Color','LineWidth','Prctile', 'LineStyle', 'parent'},...
...
%                 validateattributes(PVALUE,{'numeric'},{'real','nonnegative','nonempty','vector','numel',3,'<=',1.0},mfilename,PNAME,i+1);
            ...
            case 'LineWidth'
                ...
                line_width = PVALUE;
            case 'LineStyle'
%                 validateattributes(PVALUE,{'char'},...
%                     mfilename,PNAME,i+1);
                line_style = PVALUE;
            case 'parent'
%                 validateattributes(PVALUE,{'char'},...
